...
| `31-abdominal-emergencies` | בטן חריפה, GI bleed, UTI, כליות | `abdominal_emergency`, `acute_abdomen`, `gi_bleed`, `appendicitis_suspicion`, `renal_colic_uti`, `secondary_survey` | חלקי-טוב | חסימת מעיים וגניקולוגיה דחופה עוד לא מפורטות עד הסוף. |
