...
|---|---|---|---|---|---|---|---|---|---|---|
| UIX-401 | open | P0 | שורת הפעולות העליונה במובייל עדיין גבוהה מדי | אזור ה-toolbar העליון ב-step-by-step עדיין תופס יותר מדי גובה מסך במובייל ומקטין את כמות התוכן הקליני שמופיעה מעל ה-fold. | פידבק משתמש ישיר מ-`2026-07-01` + צילומי מסך בדיקה; בנוסף spec קובע שב-top context bar לא יהיו "too many competing controls". | לבנות toolbar מובייל צפוף באמת: שורת סטטוס קצרה + שורת פעולות נמוכה, או פס פעולות אופקי/גלילה צדית, בלי אריחים גבוהים. | Medium | 0.5-1 יום | במסך ברוחב ~390-540px שורת הפעולות מרגישה כמו toolbar קצר, לא ככרטיס שלם. לפחות חלק מהתוכן הקליני הבא מופיע מוקדם יותר בלי גלילה מיותרת. | בדיקה ידנית ברוחבי מובייל, צילום לפני/אחרי, ובדיקת tap targets. |
| UIX-402 | open | P1 | כותרת העליונה של האפליקציה עדיין צורכת יותר מדי מקום במובייל | ה-app shell העליון עדיין כולל badge + כותרת מוצר באנגלית + כפתור תפריט גדול, וביחד הוא לוקח נפח מסך יקר לפני תחילת הלמידה. | [App.tsx](/Users/evyatarhazan/Desktop/project/emergency-protocol-diagram/apps/client/src/App.tsx) + בדיקות מסך מובייל; spec דורש שה-step-by-step יהיה "center of gravity" ושמובייל ירגיש first-class. | ליצור header מובייל רזה יותר, עם פחות גובה, כותרת קצרה יותר, והפרדה ברורה בין chrome כללי לבין מסך הלמידה. | Medium | 0.5-1 יום | אזור ה-header במובייל מתקצר משמעותית בלי לאבד ניווט ותיחום מוצרי. | בדיקת גובה header בפועל, השוואת before/after, ווידוא שאין שבירה בתפריט. |
| UIX-403 | open | P1 | נשארו שאריות visible English במשטח הליבה | למרות Phase 7, הכותרת הראשית הגלויה עדיין מוצגת כ-`Emergency Protocol Diagram` במקומות מרכזיים. זה מחליש את כלל `Hebrew-first visible product`. | [App.tsx](/Users/evyatarhazan/Desktop/project/emergency-protocol-diagram/apps/client/src/App.tsx) + [ui-ux-redesign-spec.md](/Users/evyatarhazan/Desktop/project/emergency-protocol-diagram/docs/redesign/ui-ux-redesign-spec.md) תחת `Accessibility and Trust` ו-`Language must be consistently Hebrew-first`. | ליישר שמות מוצר גלויים, כותרות loading/header, ועותקי framing לשפה עברית עקבית או לשפה דו-לשונית מכוונת ומסודרת. | Low | 0.25-0.5 יום | לא נשארת כותרת אנגלית בולטת במשטח הלמידה הראשי בלי הצדקה. | סריקת UI ידנית ובדיקת strings גלויים. |
| UIX-404 | open | P1 | שכבת הקהילה במובייל עדיין inline במקום דפוס משני מובהק | ה-spec מגדיר העדפות כמו `bottom sheet on mobile` או `secondary tab/drawer`, אך כרגע הדיון עדיין מוצג inline מתחת לתוכן. הוא אמנם מונמך, אבל עדיין לא בדפוס המובייל המומלץ. | [ui-ux-redesign-spec.md](/Users/evyatarhazan/Desktop/project/emergency-protocol-diagram/docs/redesign/ui-ux-redesign-spec.md) תחת `Community Layer`; הקוד הנוכחי ב-[StepByStepView.tsx](/Users/evyatarhazan/Desktop/project/emergency-protocol-diagram/apps/client/src/components/StepByStep/StepByStepView.tsx) מראה panel inline. | להחליט אם במובייל הדיון עובר ל-bottom sheet / collapsible drawer / section סגורה כברירת מחדל, כך שלא יתחרה בגובה עם ה-core flow. | Medium | 1-2 ימים | במובייל הדיון אינו דוחף את הלומד מטה כברירת מחדל, אך נשאר נגיש וברור. | בדיקה ידנית של מסכים עם ובלי תגובות, ווידוא שאין פגיעה בהשתתפות. |
